...
function loginURL (settings) {
  return `https://discord.com/api/oauth2/authorize?client_id=${settings.clientId}&redirect_uri=${encodeURI(settings.redirectUri)}&response_type=code&scope=identify`
}
